...
#### Этот код добавляет файлы в сборку EXE
def resource_path(relative):
    if hasattr(sys, "_MEIPASS"):
        return os.path.join(sys._MEIPASS, relative)
    return os.path.join(relative)

#icon_path = resource_path('C:/Users/Freeman.Autobot/Desktop/PythonExamples/HororSnake5/python_icon.ico')
#sound_path = resource_path('C:/Users/Freeman.Autobot/Desktop/PythonExamples/HororSnake5/sounds/')
icon_path = resource_path('python_icon.ico')
sound_path = resource_path('sounds/')

################################################

#sound_path = "sounds/"
#sound_path = "C:/Users/Freeman.Autobot/Desktop/PythonExamples/HororSnake5/sounds/"
# Создаем игру и окно
os.environ['SDL_VIDEO_WINDOW_POS'] = "%d,%d" % (5,30)
pygame.init()
pygame.mixer.init()
screen = pygame.display.set_mode((WIDTH, HEIGHT),pygame.RESIZABLE)
#icon = pygame.image.load("python_icon.ico")
